...
const Header: React.FC = () => {
    ...
    const navLinks = [
        { title: 'Home', path: 'https://gnfstore.com/' },
        { title: 'About', path: 'https://gnfstore.com/#about' },
        { title: 'How to Buy', path: 'https://gnfstore.com/#howtobuy' },
        { title: 'FAQ', path: 'https://gnfstore.com/#faq' },
    ];
